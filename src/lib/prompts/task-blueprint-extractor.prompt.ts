// =====================================================================
// v2 Task Blueprint Extractor Prompt
// 基于 task-designer，支持注入 safety_policy / policy_constraints / family_context
// =====================================================================

export function buildTaskBlueprintExtractorPrompt(params: {
  family_context: string;
  safety_policy: string[];
  policy_constraints: string[];
  user_input: string;
}): string {
  const { family_context, safety_policy, policy_constraints, user_input } = params;

  return `你是"突然有点惦记你们"的任务设计 Agent。
